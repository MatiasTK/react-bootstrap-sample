...
function App() {
  return (
    <div className={`${styles.gradient} min-vh-100`}>
      <div className="container-fluid">
        <div className="d-flex align-items-center justify-content-center vh-100">
          <div className="card-group gap-3 w-75">
            <div className="card bg-dark rounded-0 shadow-lg animate__animated animate__slideInLeft">
              ...
              <div className="card-body text-center">
                ...
                <p className="card-text text-secondary">
                  Esto pagina es para probar el funcionamiento de la librería bootstrap con la combinación de react y
                  typescript.
                </p>
              </div>
            ...
            <div className="card bg-dark rounded-bottom rounded-0 shadow-lg animate__animated animate__slideInRight">
              ...
              <div className="card-body text-center">
                ...
                <p className="card-text text-secondary">
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nostrum qui corporis ipsa! Fugiat doloremque
                  praesentium dolor unde at pariatur eos inventore minima. Aliquid et est facilis in quidem laudantium
                  distinctio!
                </p>
              </div>
              <div className="card-footer text-center text-white py-3">
